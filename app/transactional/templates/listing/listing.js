                                            ...
                                            <td className="text-right">
                                                ...
                                                <div className="btn-group">
                                                    ...
                                                    <ul className="dropdown-menu text-left pull-right" id="messsage_65">
                                                        <li>
                                                            <a href="templates/preview/id/65" target="_blank" className="camp_action" ref="Preview"><i className="fa fa-eye"></i> Preview</a>
                                                        </li>
                                                        <li className="divider" role="presentation"></li>
                                                        <li className="tested_wrapper" id="65">
                                                            <a href="javascript:void(0)" id="tested_65" className="camp_action" ref="Sent test mail"><i className="fa fa-share-square-o"></i> Send a test <span className="label label-default"><i className="fa fa-unchecked"></i> Not sent</span></a>
                                                        </li>
                                                        <li>
                                                            <a href="#" className="camp_action replicate_class" ref="Replicate Template" action-name="replicate" data-type="classic"><i className="fa fa-asterisk"></i> Replicate</a>
                                                        </li>
                                                        <li>
                                                            <a className="replicate_class camp_action" ref="Replicate Template" href="#" action-name="replicate_template" data-type="template">
                                                                <span className="glyphicon glyphicon-asterisk"></span> Replicate
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a className="deleteDraft del_template camp_action" ref="Delete Draft" href="#" id="deleteDraft_91" campname="template"><span className="glyphicon glyphicon-trash"></span> Delete</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>
